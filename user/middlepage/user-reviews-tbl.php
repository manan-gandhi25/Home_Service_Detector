			...
			<td><?php echo $row['service_name']; ?></td>
					...
					<?php }else { ?>
						<div class="review-count">
										<div class="rating">
											<?php if($row1['review']=='1'){ ?>
											<i class="fas fa-star filled"></i>
										<?php } ?>
										<?php if($row1['review']=='2'){  ?>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
										<?php } ?>
										<?php if($row1['review']=='3'){  ?>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
										<?php } ?>
										<?php if($row1['review']=='4'){  ?>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
										<?php } ?>
										<?php if($row1['review']=='5'){  ?>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
											<i class="fas fa-star filled"></i>
										<?php } ?>
											<span class="d-inline-block average-rating">(<?php  echo $row1['review']; ?>)</span>
										</div>
					<?php } ?>
