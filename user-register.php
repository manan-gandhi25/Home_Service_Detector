...
<body>
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-body">
					...
					<!-- Register Form -->
					<form action="loginactionuser.php" method="POST">
					...
					<?php } ?>
						...
						<div class="text-right">
							<a class="forgot-link" href="javascript:void(0);" data-toggle="modal" data-target="#login_user">Already have an account?</a>
						</div>
	...
	<div class="modal account-modal fade" id="login_user">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="loginactionuser.php" method="POST">
						...
						<div class="text-center dont-have">Don’t have an account? <a href="user-register.php">Register</a>
						</div>
					</form>
				</div>
			</div>
